 ...
 * @author nguye
 */
public class JFdatBan1 extends javax.swing.JPanel {
    public static JFdatBan1 datBan;
    int index;
    ...
    private void tbldatBanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbldatBanMouseClicked
        ...
        try {
            ...
            Logger.getLogger(JFdatBan1.class.getName()).log(Level.SEVERE, null, ex);
        }
